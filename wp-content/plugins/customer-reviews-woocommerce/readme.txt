...
* Review tagging
* Built-in [cusrev_all_reviews] shortcode to display a list of reviews on any page or post of a website.
* Built-in [cusrev_reviews_grid] shortcode to display a grid of reviews on any page or post of a website.
* Built-in [cusrev_reviews_slider] shortcode to display a responsive reviews slider on any page or post of a website.
...
* Add a tab with questions and answers (Q & A) to product pages on your website
* Let your prospective customers ask questions about products and view questions asked by others
* Increase sales by answering the questions and making sure that prospective customers have all the information available to make a purchase decision
* Reduce return and refund requests by providing answers to common questions about products and offering additional information to avoid misunderstanding about product features
* Improve SEO with Q & A content created by your customers that helps search engines better understand and index your website for relevant long-tail keywords
...
* Localized to over 40 languages
* You can contribute a localization to your language from the 'Review Reminder' tab in the plugin's settings

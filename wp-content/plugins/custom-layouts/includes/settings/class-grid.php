...
class Grid {
	...
	public static function get_data() {
		$settings_data = array(
			...
			array(
				'name'    => 'item_spacing',
				'label'   => __( 'Item Spacing', 'custom-layouts' ),
				'type'    => 'Number',
				'min'     => '0',
				'max'     => '100',
				'default' => '5',
			...
			array(
				...
				'description' => __( 'Seperate class names with a space', 'search-filter' ),
				'tab'         => 'advanced',
				'type'        => 'Text',
				'placeholder' =>  __( 'Add a CSS class to the filter', 'search-filter' ),
			),
		);
	...
	public static function get_post_types_w_archive() {
		...
		foreach ( $wp_post_types as $post_type ) {
			...
			if((($post_type->has_archive)&&($post_type->public)) || ($post_type->name=="post")) {
				$item          = array();

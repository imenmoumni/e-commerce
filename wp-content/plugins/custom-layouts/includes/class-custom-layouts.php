...
if ( ! defined( 'CUSTOM_LAYOUTS_VERSION' ) ) {
	define( 'CUSTOM_LAYOUTS_VERSION', '1.4.1' );
}
...
class Custom_Layouts {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/settings/defaults.php';
	...
	private function define_ajax_hooks() {
		...
		// stop doing this
		// $this->loader->add_action( 'wp_ajax_custom_layouts_css', 'Custom_Layouts\\Core\\CSS_Loader', 'get_ajax_css', 9 );
		// $this->loader->add_action( 'wp_ajax_nopriv_custom_layouts_css', 'Custom_Layouts\\Core\\CSS_Loader', 'get_ajax_css', 10 );

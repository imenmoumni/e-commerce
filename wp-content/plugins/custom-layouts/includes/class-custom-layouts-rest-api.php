...
class Rest_API {
	...
	public function add_routes() {
		register_rest_route( 'custom-layouts/v1', '/layout/results',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/templates/get',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/layouts/get',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/post_types',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/authors',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/taxonomy/terms',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/posts/search',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/custom-fields',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/taxonomies',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/image_sizes',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/taxonomies/terms',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/custom-field',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/template/sources',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/template/get',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/layout/get',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/template/save',
			array(
				'methods'              => 'POST',
		...
		register_rest_route( 'custom-layouts/v1', '/layout/save',
			array(
				'methods'              => 'POST',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/posts/results',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/wp/post',
			array(
				'methods'              => 'GET',
		...
		register_rest_route( 'custom-layouts/v1', '/layout/info', array(
				'methods'              => 'GET',
				'callback'             => array( $this, 'get_layout_info' ),
				'permission_callback' => array( $this, 'permissions' ),
			)
		);
		register_rest_route( 'custom-layouts/v1', '/css/regenerate', array(
				'methods'              => 'GET',
	...
	private function get_template_posts( $query ) {
		$posts = array();
	...
	public function get_layout_template_results( \WP_REST_Request $request ) {
		...
		//return rest_ensure_response( $post_type_data );
	...
	public function get_post_type_results( \WP_REST_Request $request ) {
		...
		// fix post types TODO - need to standardise our queries across everything
		/*$query_args['post_type'] = $query_args['post_types'];
	...
	public function get_templates_options( \WP_REST_Request $request ) {
		...
		$templates = Settings::get_templates_options();
